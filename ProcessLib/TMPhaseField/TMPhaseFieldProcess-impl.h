...
template <int DisplacementDim>
void TMPhaseFieldProcess<DisplacementDim>::assembleWithJacobianConcreteProcess(
...
template <int DisplacementDim>
void TMPhaseFieldProcess<DisplacementDim>::postNonLinearSolverConcreteProcess(
