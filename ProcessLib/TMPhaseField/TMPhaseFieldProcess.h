...
#ifndef PROCESS_LIB_TMPHASEFIELDPROCESS_H_
#define PROCESS_LIB_TMPHASEFIELDPROCESS_H_
...
private:
    ...
    {
        ProcessLib::TMPhaseField::createLocalAssemblers<DisplacementDim,
                                                          LocalAssemblerData>(
                                    ...
                                    double const dt) override
    {
        ...
        GlobalExecutor::executeMemberOnDereferenced(
            &PhaseFieldLocalAssemblerInterface::preTimestep,
    ...
    void postTimestepConcreteProcess(GlobalVector const& x) override
    {
        ...
        GlobalExecutor::executeMemberOnDereferenced(
            &PhaseFieldLocalAssemblerInterface::postTimestep,
...
#endif  // PROCESS_LIB_TMPHASEFIELDPROCESS_H_
