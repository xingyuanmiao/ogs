...
#ifndef MATERIALLIB_SOLIDMODELS_VISCOELASTICBURGERS_IMPL_H_
#define MATERIALLIB_SOLIDMODELS_VISCOELASTICBURGERS_IMPL_H_
...
#endif  // MATERIALLIB_SOLIDMODELS_VISCOELASTICBURGERS_IMPL_H_
